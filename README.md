...
<body>
  ...
  <p>O cliente pode ser um computador pessoal, um smartphone, um tablet ou qualquer outro dispositivo conectado à rede. Ele utiliza aplicativos ou navegadores para interagir com os serviços disponíveis em um <strong style="color:orange;">servidor</strong>.</p>
  <center>
  <img src="https://www.gta.ufrj.br/ensino/eel879/trabalhos_vf_2010_2/andre/images/Server-based-network.png" width="315" height="315" aling="middle">
  </center>
  <br>
  <small><sup><strong>*</strong></sup> <i>Um servidor é um computador ou sistema que fornece serviços ou recursos a outros dispositivos na rede, como armazenamento de dados, hospedagem de sites ou gerenciamento de conexões de rede.</i></small>
  <p>A interação entre o cliente e o servidor é geralmente baseada em um modelo cliente-servidor, no qual o cliente faz solicitações e o servidor responde a essas solicitações. Os clientes podem ser tanto clientes de <strong style="color:orange;">rede local</strong> quanto <strong style="color:orange;">clientes da web</strong>, dependendo do tipo de comunicação e serviços envolvidos.</p>
  <p>Em suma, o cliente na computação é o responsável por solicitar e receber serviços ou recursos de um servidor, desempenhando um papel fundamental na comunicação e na interação entre os dispositivos e os sistemas de computação.</p>
  <small><strong><sup>*</sup></strong> <i>Uma rede local é uma infraestrutura de comunicação que interconecta dispositivos em uma área geograficamente limitada, como uma residência, escritório ou edifício, permitindo o compartilhamento de recursos e troca de informações.</i></small>
  <br>
  <br>
  ...
  <p>Os servidores são projetados para executar tarefas específicas, como hospedar websites, armazenar e compartilhar arquivos, fornecer serviços de email, gerenciar bancos de dados, entre outros. Eles possuem uma capacidade de processamento e armazenamento maior do que os clientes, permitindo atender a múltiplas solicitações simultaneamente.</p>
  <center>
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHdmyPnwz4sKWu9xbPPVCSyBBcDd4BXSstqw&usqp=CAU" width="314" height="208" aling="middle">
  </center>
  <p>Os servidores podem operar em redes locais ou na Internet, dependendo do escopo e da finalidade dos serviços que eles oferecem. Eles são configurados e mantidos por administradores de sistemas, que garantem seu funcionamento adequado, segurança e disponibilidade.</p>
  <p>Em resumo, os servidores desempenham o papel de fornecer serviços, recursos ou informações aos clientes, permitindo a comunicação e a interação entre dispositivos e sistemas de computação. Eles são peças fundamentais da infraestrutura de rede e desempenham um papel crítico no suporte às operações e serviços computacionais.</p>
  
  <h2 style="font-family:Times New Roman;color:purple;" id="grandes-nomes">Grandes nomes da Tecnologia</h2>
  <small><a href="#inicio">(voltar)</a></small>
  <div class="distancia">
...
<div class="distancia" style="clear: both;">
  ...
  <p><li>Diretor do World Wide Web Consortion <strong style="color:orange;"><u>(W3C)</u></strong></p>
...
<div class="distancia" style="clear: both;">
  ...
  <center>
      ...
      <small><strong><sup>*</sup></strong> <i>A Microsoft é uma das maiores empresas de tecnologia do mundo, fundada em 1975, que desenvolve software, hardware e serviços, incluindo o sistema operacional Windows e a suíte de produtividade Office, entre outros produtos amplamente utilizados.</i></small>
      </center>
      </div>
  <div class="distancia" style="clear: both;">
    <br><hr class="gradient">
